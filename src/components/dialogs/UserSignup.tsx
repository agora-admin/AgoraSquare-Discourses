		...
		<div className="bg-black flex flex-row justify-center w-full">
			<div className="bg-black w-screen h-screen flex items-center justify-center">
				<div className="inline-flex flex-col items-center gap-[24px] absolute top-0 left-0">
					<div className="flex w-screen items-center justify-around gap-[10px] px-[85px] py-[24px] relative flex-[0_0_auto]">
				...
				<section className="inline-flex items-center gap-[250px] p-[10px] bg-black">
...
export const Textbox = ({ className, placeholder }) => {
	return (
		<div
			className={`inline-flex items-center gap-[24px] relative bg-[#141414] rounded-[16px] border-2 border-solid border-[#1e1e1e] ${className}`}>
			<input
				className="relative w-full mt-[-2.00px] bg-[#141414] rounded-2xl px-[16px] py-[20px] [font-family:'Montserrat-SemiBold',Helvetica] font-semibold text-[#7c8b91] text-[12px] tracking-[0] leading-[14.4px] whitespace-nowrap"
