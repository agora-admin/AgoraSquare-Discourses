        ...
        <div className="w-full flex gap-2 justify-between">
            {
                supportedChainIds.map(chainId => (
                    ...
                    <button key={chainId} onClick={() => handleSwitch(parseInt(chainId as string))} className={`outline-none t-all p-1 rounded-lg border ${activeChain?.id === chainId ? ' border-[#212427] cursor-default' : 'border-transparent contrast-0 grayscale hover:bg-[#c6c6c6]/10 '}`}>
