...
export const UnstoppableIcon = ({size=20}:SVGProp) => (
    <svg width={size} height={size} viewBox="0 0 38 39" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M37.2096 0.642578V15.4488L0 32.9439L37.2096 0.642578Z" fill="#00C9FF"/>
        <path d="M30.2339 0V25.5417C30.2339 29.111 29.0087 32.5342 26.8279 35.0581C24.6471 37.5821 21.6893 39 18.6052 39C15.521 39 12.5632 37.5821 10.3824 35.0581C8.2016 32.5342 6.97644 29.111 6.97644 25.5417V14.7791L13.9525 10.3359V25.5417C13.8872 26.2053 13.9437 26.8774 14.1184 27.514C14.2932 28.1506 14.5822 28.7372 14.9665 29.2355C15.3508 29.7338 15.8217 30.1325 16.3484 30.4055C16.8751 30.6785 17.4457 30.8197 18.0229 30.8197C18.5999 30.8197 19.1706 30.6785 19.6973 30.4055C20.2239 30.1325 20.6949 29.7338 21.0792 29.2355C21.4635 28.7372 21.7525 28.1506 21.9272 27.514C22.102 26.8774 22.1585 26.2053 22.0932 25.5417V5.15439L30.2339 0Z" fill="#0D67FE"/>
    </svg>
)